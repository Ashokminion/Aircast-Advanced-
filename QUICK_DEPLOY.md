# 🚀 Quick Deployment Guide - Theni AirCast
...
4. **Configure deployment**:
   - Repository: `Ashokminion/Aircast-Advanced-` (or your repo)
   - Branch: `main`
...
7. **Copy your URL**: Will look like `https://ashokminion-aircast-advanced.streamlit.app`
...
2. **Select your project**: `aircast-advanced`
...
1. Visit: https://aircast-advanced.vercel.app/predictor
